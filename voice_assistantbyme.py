...
#     print("Arduino Board Not Connected!")
#     speak("Arduino Board Not Connected!")
...
def main():
    ...
    while True:
        ...
        #     f=open("C:\\Users\\ASUS\\Desktop\\Openweathermap.txt","r")
        #     user_api=f.readline()
        #     f.close()
        ...
        #     os.startfile(os.path.join(music_dir, songs[random.randrange(0,(len(songs)-1))]))
            ...
            query1=takeCommand().lower()
            if "yes friday i want to restart the computer" in query1:
                print("Thank you Boss for interacting with me.")
                speak("Thank you Boss for interacting with me.")
